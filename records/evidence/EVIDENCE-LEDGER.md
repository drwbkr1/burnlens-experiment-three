...
| `E3-EVID-0102` | `MISSING` | Activated runtime and verified installed dependency lock | Candidate identity and private resolution lock exist as `E3-EVID-0027` through `E3-EVID-0029`; download, installation, adoption, import, and activation verification remain owner-gated. |
