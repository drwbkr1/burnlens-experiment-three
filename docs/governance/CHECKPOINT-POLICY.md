...
python C:\Users\drewb\.codex\skills\standardize-project-control-plane\scripts\validate_project_control.py records/governance/EXPERIMENT-THREE-PROJECT-CONTROL-PROFILE-2026-006.json --project-root . --verify-paths --milestone-contract records/milestones/EXPERIMENT-THREE-MILESTONE-005-RETROSPECTIVE-EVALUATION-2026-001.json
python C:\Users\drewb\.codex\skills\run-controlled-milestone\scripts\validate_milestone.py records/milestones/EXPERIMENT-THREE-MILESTONE-005-RETROSPECTIVE-EVALUATION-2026-001.json --project-profile records/governance/EXPERIMENT-THREE-PROJECT-CONTROL-PROFILE-2026-006.json
python C:\Users\drewb\.codex\skills\reconcile-project-state\scripts\evaluate_project_state.py records/reconciliations/EXPERIMENT-THREE-STATE-2026-006.json --project-root . --verify-paths
